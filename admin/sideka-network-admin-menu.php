...
function sideka_site_synchronize($site, $category_configs, $event_category_configs, $role_configs){
...
function sideka_sites_synchronize()
{
    if(is_super_admin()){
            ...
            foreach ($sites as $site) {
                $output["results"][] = sideka_site_synchronize($site, $category_configs, $event_category_configs, $role_configs);
            }
